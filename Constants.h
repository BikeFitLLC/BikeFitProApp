 ...
 */
#define TOKEN_VENDING_MACHINE_URL    @"velopeztvm-env.elasticbeanstalk.com"
//#define TOKEN_VENDING_MACHINE_URL    @"localhost:8080/IdentityTVM"
...
#define CREDENTIALS_ALERT_MESSAGE    @"Alert."
#define ACCESS_KEY_ID                @""  // Leave this value as is.
#define SECRET_KEY                   @""  // Leave this value as is.


//Velopez Specific
#define SDB_CLIENTS_DOMAIN_FORMAT           @"%@_clients"
